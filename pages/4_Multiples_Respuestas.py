...
st.session_state["desirability_result"] = {
    "responses": selected,
    "x_opt": np.asarray(result["x_opt"]).tolist(),
    "D_opt": float(D_opt),
    "detail": [
        {"respuesta": row["Respuesta"], "y_hat": row["Valor predicho"], "d": row["Deseabilidad individual (d)"]}
...
st.info("➡️ Continúa en **📈 Visualización**, o ve a **📄 Reporte Final** para descargar un informe en PDF con todos estos resultados.")
